...
const Billboard = () => {
  ...
  return (
    <div className="relative h-[32rem] lg:h-[44rem]">
      ...
      ></video>
      <div className="absolute top-[30%] md:top-[40%] lg:top-[50%] text-white">
        ...
        <div className="flex flex-row ml-6 lg:ml-9 items-center mt-5 md:mt-7 gap-3">
          ...
          <button
            className="bg-white text-white bg-opacity-25 py-1 md:py-3 px-3 md:px-6
          w-auto text-xs lg:text-lg font-semibold flex flex-row items-center hover:bg-opacity-15 transition"
          >
            <InformationCircleIcon className="w-4 md:w-5 lg:md-7 mr-2" />
            More Info
          </button>
        </div>
      </div>
